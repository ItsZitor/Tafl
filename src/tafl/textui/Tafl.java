 ...
 * 
 * En algunos casos los métodos estáticos son meros envoltorios o "wrappers"
...
public class Tafl {
	 ...
	 *                                  validada
	 */
	private static void realizarMovimientoYCapturas(Jugada jugada) throws IllegalArgumentException {
		try {
