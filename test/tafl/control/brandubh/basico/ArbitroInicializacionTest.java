...
/**
 * Comprobación del ArbitroBrandubh de inicialización de la partida
 ...
 * @version 1.0
 */
@DisplayName("Tests del ArbitroBrandubh sobre la inicialización de piezas.")
...
public class ArbitroInicializacionTest extends tafl.control.basico.ArbitroAbstractoInicializacionTest{
	...
	class ColocacionInicialDePiezas {
		...
		@ParameterizedTest
		@MethodSource("tafl.control.TestUtil#piezaYCoordenadaDeAtacanteBrandubhProvider")
		...
		@ParameterizedTest
		@MethodSource("tafl.control.TestUtil#piezaYCoordenadaDeDefensorBrandubhProvider")
