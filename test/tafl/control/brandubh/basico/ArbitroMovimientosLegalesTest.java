...
/**
 * Comprobación del ArbitroBrandubh de movimientos legales del árbitro.
 * 
 ...
 */
@DisplayName("Tests del ArbitroBrandubh sobre el control de  movimientos legales.")
...
public class ArbitroMovimientosLegalesTest extends tafl.control.basico.ArbitroAbstractoMovimientosLegalesTest {
	...
	@Test
	void comprobarSePuedeMoverSobreLaCeldaTronoUnDefensorSinPararSobreElla() throws CoordenadasIncorrectasException {
		// given
		// when
		arbitro.mover(fabricarJugada(tablero,3,4,6,4)); // defensor
		arbitro.mover(fabricarJugada(tablero,3,3,3,4)); // mover rey y abandonar trono		
	...
	@Test
	void comprobarSePuedeMoverSobreLaCeldaTronoUnAtacanteSinPararSobreElla() throws CoordenadasIncorrectasException {
		// given
		// when
		arbitro.mover(fabricarJugada(tablero,3,4,6,4)); // defensor
		arbitro.mover(fabricarJugada(tablero,3,3,3,4)); // mover rey y abandonar trono		
