 ...
 * @version 1.0
 */
@DisplayName("Tests del ArbitroArdRi sobre la validación de argumentos.")
...
public class ArbitroValidacionArgumentosTest extends tafl.control.medio.ArbitroAbstractoValidacionArgumentosTest {
	...
	void comprobarConstructorConTableroNulo() {
		...
		// when
		// then
		assertThrows(IllegalArgumentException.class, () -> new ArbitroArdRi(tablero));
	}	
}
